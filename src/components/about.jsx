...
const About = () => {
  return (
    <div className='container-fluid bg-custom' data-bs-spy="scroll" data-bs-target="#navbar-example2" id='scrollspyHeading2'>
      <div className='row'>
      ...
      <div className='row mt-5'>
        <div className='col-lg-5 col-12 offset-lg-1 order-lg-1 order-2'>
        ...
        <div className='col-lg-4 col-12 offset-lg-1 order-lg-2 order-1 justify-content-center align-items-center'>
          <div className='profile'>
            <div className="profile-img"><img src={self} alt='profile'/></div>
