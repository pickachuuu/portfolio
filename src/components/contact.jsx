    ...
    <div className="container-fluid bg-custom" data-bs-spy="scroll" data-bs-target="#navbar-example2" id="Contact">
      ...
      <div className="row">
        <div className="col-12 mx-auto">
          ...
          <h1 className="display-2 text-light text-center my-5">
              Get in Touch
              <hr></hr>
            </h1>
            <div className="row justify-content-center">
              <div className="col-lg-5 col-12">
              <form className="form bg-dark shadow mb-3" action='https://formspree.io/f/meqyqqzb' method='POST'>
              ...
              <div className="col-lg-5">
                <div className='custom-cntr shadow bg-dark'>
                  <h1 className='display-6 text-light text-center'>Socials<hr></hr></h1>
                  <div className='mx-auto'>
                  <div className="social-crd">
                    <a className="social-link2" href='https://github.com/pickachuuu'>
                    ...
                    <a className="social-link3" href='linkedin.com/in/chris-derek-berbo-b81a612a4/'>
                    ...
                    <a className="social-link5" href='https://stackoverflow.com/users/23180670/pikachuuuuu'>
                ...
                <div className='custom-cntr mt-3 shadow bg-dark'>
                  ...
                  <svg style={{ color: 'white', width: '50px', height: '50px' }} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" zoomAndPan="magnify" viewBox="0 0 30 30.000001" preserveAspectRatio="xMidYMid meet" version="1.0">
                    <path fill="white" d="M 24.230469 11.101562 L 15 16.769531 L 5.769531 11.101562 L 5.769531 8.832031 L 15 14.503906 L 24.230469 8.832031 Z M 24.230469 6.5625 L 5.769531 6.5625 C 4.492188 6.5625 3.472656 7.578125 3.472656 8.832031 L 3.460938 22.441406 C 3.460938 23.695312 4.492188 24.707031 5.769531 24.707031 L 24.230469 24.707031 C 25.507812 24.707031 26.539062 23.695312 26.539062 22.441406 L 26.539062 8.832031 C 26.539062 7.578125 25.507812 6.5625 24.230469 6.5625 " fillOpacity="1" fillRule="nonzero"></path>
                  </svg>
                  </a>
                  </div>
